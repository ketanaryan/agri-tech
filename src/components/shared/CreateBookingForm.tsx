...
export function CreateBookingForm({ farmers, items }: CreateBookingFormProps) {
  ...
  const [msg, setMsg] = useState<{ text: string; type: "success" | "error"; waUrl?: string } | null>(null);
        ...
        >
          ...
          {msg.waUrl && (
            <a 
              ...
              className="mt-3 inline-flex items-center justify-center gap-2 px-4 py-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white rounded-md transition-colors font-semibold"
            >
